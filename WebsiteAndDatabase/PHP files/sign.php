...
if (isset($_POST['SignUpButton'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO logindetails (username, password) VALUES (?, ?)");
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<span style = "color: #fff; font-size:20px">Sign Up</span>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3">
					<form class="text-center" method="POST">
						...
						<div class="col-md-12 col-md-offset-4">
							<input style="width: 30%; height: 40px;" type="submit" value ="Sign Up" class="btn btn-default btn-block" name = "SignUpButton">
						</div>
						<div class="col-md-10 col-md-offset-1">
							<span class="text-center" style="font-size:20px; margin:10px; color:#fff">Already got an account? Click the button below!</span>
						</div>
						<div class="col-md-8 col-md-offset-2">	
							<a style="margin:10px; font-size:20px; color:#0275d8" href = "log.php"><u>Log In<u></a>
						</div>
					</form>
				</div>
			</div>
